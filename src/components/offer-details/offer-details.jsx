...
import {offerTypesMap, offerAmenitiesMap} from "../../const.js";
...
class OfferDetails extends PureComponent {
  ...
  render() {
    const {rentOffer} = this.props;
    const {id, title, price, type, rating, isPremium, description, photos, host, bedroomCount, maxGuestCount, amenities} = rentOffer;
            ...
            <div className="property__wrapper">
              ...
              <ul className="property__features">
                ...
                <li className="property__feature property__feature--adults">
                  {maxGuestCount === 1 ? `Max ${maxGuestCount} adult` : `Max ${maxGuestCount} adults`}
                </li>
              </ul>
